      ...
      <div className="mx-auto w-full max-w-screen-xl p-3 py-0 lg:py-8">
        <div className="md:flex md:justify-between">
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-4 sm:grid-cols-2">
            <div>
              <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Sitios oficiales</h2>
              <ul className="text-gray-500 dark:text-gray-400 font-medium">
                <li className="mb-4">
                  <a href="https://www.inf.ucv.cl/" className="hover:underline">Escuela de Ingeniería Informatica</a>
                </li>
              </ul>
            </div>
            <div>
        ...
        <hr className="my-4 border-gray-200 sm:mx-auto dark:border-gray-700 lg:my-10" />
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:grid-rows-2">
          {/* Primera fila, columna izquierda */}
          <p className="text-sm text-gray-500 sm:col-span-1 dark:text-gray-400">
