...
const Footer = () => {
  return (
    <footer class="bg-white dark:bg-gray-900">
        <div class="mx-auto w-full max-w-screen-xl p-3 py-0 lg:py-8">
            <div class="md:flex md:justify-between">
              <div class="mb-6 md:mb-0">
                  
                    <img src="/logo_smaller-01.png" class="h-8 me-3" alt="EII PUCV" />
          ...
          <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:grid-rows-2">
                ...
                <div class="flex justify-start sm:justify-end sm:col-span-1">
                    <a href="https://facebook.com/informatica.pucv" class="text-gray-500 hover:text-gray-900 dark:hover:text-white me-5">
                        <svg class="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 8 19">
                            <path fill-rule="evenodd" d="M6.135 3H8V0H6.135a4.147 4.147 0 0 0-4.142 4.142V6H0v3h2v9.938h3V9h2.021l.592-3H5V3.591A.6.6 0 0 1 5.592 3h.543Z" clip-rule="evenodd" />
                        </svg>
                        <span class="sr-only">Facebook page</span>
                    </a>
                    <a href="https://x.com/INGENIERIAPUCV" class="text-gray-500 hover:text-gray-900 dark:hover:text-white me-5">
                    ...
                    <a href="https://www.instagram.com/informatica.pucv/?hl=es" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                ...
                {/* Segunda fila */}
                <p class="text-sm text-gray-500 sm:col-span-2 text-center dark:text-gray-400">
